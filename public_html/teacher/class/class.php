...
<div class="container-gv chunhiem">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <?php if ($homeroom_class): ?>
                    <a href="/teacher/class/input-score/input-score.php?class_id=<?= $homeroom_class['id'] ?>">Nhập điểm</a>
                <?php else: ?>
                    -
                <?php endif; ?>
            </td>
        ...
        <?php if (!empty($subject_classes)): ?>
            <?php foreach ($subject_classes as $class): ?>
                <tr>
                    ...
                    <td><a href="/teacher/class/students-list/student-list.php?class_id=<?= $class['id'] ?>">Xem chi tiết</a></td>
                    <td><a href="/teacher/class/input-score/input-score.php?class_id=<?= $class['id'] ?>">Nhập điểm</a></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
